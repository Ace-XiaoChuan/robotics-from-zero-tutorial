# Lesson 11：MuJoCo 视觉、AprilTag 与传感器数据采集
...
```bash
python3 src/lesson11/cv_trainning/mujoco_get_camera_picture.py
```
...
```bash
python3 src/lesson11/cv_trainning/demo/sim_camera_tag_pose_demo.py
```
